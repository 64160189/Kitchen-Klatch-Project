                        ...
                        data.data.forEach(post => {
                            ...
                            <div class="card-body">
                                ...
                                <div class="d-flex align-items-center mt-2">
                                    <img class="avatar-sm rounded-circle border border-dark" src="${post.user && post.user.image_url ? post.user.getImageURL() : '/default-avatar.png'}" style="width: 5%;">
                                    <a href="/users/${post.user ? post.user.id : ''}" class="fw-semibold text-decoration-none text-danger ms-2">
                                    ${post.user ? post.user.name.substring(0, 20) : 'Unknown'} <span class="text-muted">#${post.user ? post.user.id : '--'}</span>
                                    </a>
                                </div>
                            </div>
                        `;
