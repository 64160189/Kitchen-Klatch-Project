                        ...
                        <div class="offcanvas-body">
                            <ul class="navbar-nav justify-content-end flex-grow-1 pe-3">
                                ...
                                <li class="nav-item">
                                    ...
                                    <a class="nav-link"
                                        href="{{ route('admin.viewReportedPosts') }}">โพสต์ที่ถูกรายงานทั้งหมด</a>
                                </li>
                            </ul>
                        </div>
                    </div>
                    ...
                    <div class="row justify-content-center">
                        ...
                        <div class="row col-9">
                            <div class="col-8 mb-3">
                                <h4 class="fw-bold">โพสต์ที่ถูกรายงานทั้งหมด {{ $reportedPosts->count() }} โพสต์</h4>
                                {{-- SEARCH --}}
                            ...
                            <div class="col mb-3"> {{-- SORT BY DROPDOWN --}}
                                ...
                                <select id="sort-by" class="form-select" onchange="sortReportedPosts()">
                        ...
                        <div class="card col-9 mt-2">
                            {{-- แสดงโพสต์ที่ถูกรายงาน --}}
                            @if ($reportedPosts->isEmpty())
                                <div class="alert alert-warning m-3">ไม่มีโพสต์ที่ถูกรายงานในขณะนี้</div>
                            @else
                                            ...
                                            <div class="d-flex align-items-center">
                                                ...
                                                <div class="m-2">
                                                    ...
                                                    <span class="fw-bold text-danger"
                                                        style="font-size: 1.0rem;">เหตุผลที่รายงาน:
                                                        <span class="text-muted">{{ $post->reason }}</span>
                                                    </span><br> {{-- แสดงเหตุผลที่ถูกรายงาน --}}
                                                </div>
                                            </div>
                                        </div>
                                        <!-- Delete Form in Post -->
